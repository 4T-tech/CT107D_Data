...
<img src="%5B7%5D图片/蓝桥杯单片机竞赛平台主视图.jpg" alt="蓝桥杯单片机竞赛平台主视图" width="60%">



## 文件结构

- [1]例程_四梯教研编：四梯教研编写的CT107D硬件平台的例程
  - IO模式例程
  - MM模式例程
- [2]例程_单片机设计与开发实训指导书：单片机设计与开发实训指导书配套例程
- [3]开发环境及辅助工具
  - 串口调试助手
  - 解压缩软件
  ...
  - STC-ISP下载软件
- [4]硬件平台相关资料
  - 相关芯片手册：CT107D硬件平台上相关芯片手册大全
  - CT107D_UM：蓝桥杯单片机设计与开发竞赛实训平台用户手册
  - SCH_V40：CT107D硬件平台原理图
  - STC Monitor仿真器使用说明

- USB驱动：USB驱动_CT107D开发板与PC连接时的USB端口驱动
  - X64版
  - X86版
  - 驱动程序安装说明
- [6]测试文件
